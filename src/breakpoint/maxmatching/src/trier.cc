...
int trier::solve()
{
	...
	printf("run maxmatching ...\n");
	maxmatching d(conf, gm1, gm2);
	d.solve();
...
int trier::evaluate()
{
	...
	printf("genome1: %5d out of %5d maxmatchings are correct. ratio = %8.3lf\n", s1, n, 1.0 * s1 / n);
	printf("genome2: %5d out of %5d maxmatchings are correct. ratio = %8.3lf\n", s2, n, 1.0 * s2 / n);
